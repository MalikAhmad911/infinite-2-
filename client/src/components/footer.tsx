      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          <div className="lg:col-span-2">
            ...
            <div className="inline-flex flex-col items-center gap-1.5 rounded-xl bg-white px-6 py-5 mb-3">
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", color: "#5F6368" }} className="text-sm font-medium">Google Partner</span>
            </div>
            <div>
