...
export default function About() {
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <FadeIn>
              ...
              <h2 className="font-heading font-bold text-3xl sm:text-4xl text-brand-dark tracking-tight leading-tight">
                From Startup to
                <br />
              ...
              <div className="flex items-center gap-2 mt-6 px-4 py-2.5 rounded-md border border-brand-blue/10 bg-brand-blue/5 w-fit">
              ...
              <div className="space-y-6">
                {timeline.map((item, i) => (
                  ...
                  >
                    ...
                    <div className="pb-6">
                      <span className="font-stat text-xl text-brand-blue tracking-wider">{item.year}</span>
                      <h3 className="font-heading font-semibold text-brand-dark mt-1">{item.title}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v, i) => (
              <FadeIn key={v.title} delay={i * 0.08}>
                <div className="glass-card glass-card-hover rounded-xl p-6 h-full transition-all duration-300">
                  <div className="w-12 h-12 rounded-md bg-brand-blue/10 flex items-center justify-center mb-4">
                    <v.icon className="w-6 h-6 text-brand-blue" />
                  </div>
                  <h3 className="font-heading font-semibold text-brand-dark text-lg mb-2">{v.title}</h3>
      ...
      <section className="py-20 lg:py-32 relative overflow-hidden bg-gradient-cta noise-bg">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeIn>
            ...
            <a href="https://infiniterankers.io" target="_blank" rel="noopener noreferrer" className="mt-6 inline-block text-sm text-brand-muted hover:text-brand-blue transition-colors" data-testid="link-about-site">Visit infiniterankers.io →</a>
          </FadeIn>
        </div>
      </section>
    </div>
